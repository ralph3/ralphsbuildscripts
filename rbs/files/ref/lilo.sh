...
SRC1=(
http://home.san.rr.com/johninsd/pub/linux/lilo/${TARBALL}
)
...
version_check_info(){
  ADDRESS='http://home.san.rr.com/johninsd/pub/linux/lilo/'
  VERSION_STRING='lilo-%version%.src.tar.gz'
  MIRRORS=(
    'http://home.san.rr.com/johninsd/pub/linux/lilo/lilo-%version%.src.tar.gz'
  )
}
