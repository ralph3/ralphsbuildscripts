...
MD5SUMS=(
cbf3d8be3e3516dcb12b751de822b48c
)

build(){
  unpack_tarball $TARBALL || return 1
  cd $SRCDIR/$DIR || return 1
  do_patch openjade-1.3.3-pre1-iostream-1.patch || return 1
...
version_check_info(){
  ADDRESS='http://sourceforge.net/project/showfiles.php?group_id=2115&package_id=2051'
